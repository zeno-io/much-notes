...
public interface UserAccountBookAuthDOMapper {
    ...
    @Insert({
        "insert into user_account_book_auth (uid, account_book_id, ",
        "is_admin, block, ",
        "create_time, update_time, ",
        "remark, is_deleted)",
        "values (#{uid,jdbcType=BIGINT}, #{accountBookId,jdbcType=BIGINT}, ",
    ...
    @Select({
        "select",
        "id, uid, account_book_id, is_admin, block, create_time, update_time, remark, ",
        "is_deleted",
