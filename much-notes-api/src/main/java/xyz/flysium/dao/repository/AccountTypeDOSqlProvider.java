...
import xyz.flysium.dao.entity.AccountTypeDOExample.Criteria;
import xyz.flysium.dao.entity.AccountTypeDOExample.Criterion;

public class AccountTypeDOSqlProvider {
    public String countByExample(AccountTypeDOExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AccountTypeDO record = (AccountTypeDO) parameter.get("record");
