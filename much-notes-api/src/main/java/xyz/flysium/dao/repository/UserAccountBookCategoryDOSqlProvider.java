...
import xyz.flysium.dao.entity.UserAccountBookCategoryDOExample.Criteria;
import xyz.flysium.dao.entity.UserAccountBookCategoryDOExample.Criterion;

public class UserAccountBookCategoryDOSqlProvider {
    public String countByExample(UserAccountBookCategoryDOExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("user_account_book_category");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(UserAccountBookCategoryDO record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("user_account_book_category");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserAccountBookCategoryDO record = (UserAccountBookCategoryDO) parameter.get("record");
    ...
    protected void applyWhere(SQL sql, UserAccountBookCategoryDOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
