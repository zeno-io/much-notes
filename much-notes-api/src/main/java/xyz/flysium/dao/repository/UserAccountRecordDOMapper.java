...
public interface UserAccountRecordDOMapper {
    ...
    @Insert({
        "insert into user_account_record (uid, money, ",
        "type, account_type, ",
        "account_book_id, time, ",
        "time_year, time_month, ",
        "time_day, category_name, ",
        "category_id, create_time, ",
        "update_time, remark, ",
        "is_deleted)",
        "values (#{uid,jdbcType=BIGINT}, #{money,jdbcType=BIGINT}, ",
        "#{type,jdbcType=TINYINT}, #{accountType,jdbcType=INTEGER}, ",
        "#{accountBookId,jdbcType=BIGINT}, #{time,jdbcType=DATE}, ",
        "#{timeYear,jdbcType=INTEGER}, #{timeMonth,jdbcType=INTEGER}, ",
        "#{timeDay,jdbcType=INTEGER}, #{categoryName,jdbcType=VARCHAR}, ",
        "#{categoryId,jdbcType=BIGINT}, #{createTime,jdbcType=TIMESTAMP}, ",
    ...
    @Select({
        "select",
        "id, uid, money, type, account_type, account_book_id, time, time_year, time_month, ",
        "time_day, category_name, category_id, create_time, update_time, remark, is_deleted",
