...
import xyz.flysium.dao.entity.CategoryDOExample.Criteria;
import xyz.flysium.dao.entity.CategoryDOExample.Criterion;

public class CategoryDOSqlProvider {
    public String countByExample(CategoryDOExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(CategoryDO record) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CategoryDO record = (CategoryDO) parameter.get("record");
    ...
    protected void applyWhere(SQL sql, CategoryDOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
