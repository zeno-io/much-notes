...
public class UserAccountBookAuthDO implements Serializable {
  ...
  public Date getUpdateTime() {
    ...
    public boolean equals(Object that) {
        ...
        UserAccountBookAuthDO other = (UserAccountBookAuthDO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
          ...
          && (this.getIsAdmin() == null ? other.getIsAdmin() == null
          : this.getIsAdmin().equals(other.getIsAdmin()))
          && (this.getBlock() == null ? other.getBlock() == null
