...
public class UserAccountRecordDO implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getAccountBookId() == null ? other.getAccountBookId() == null : this.getAccountBookId().equals(other.getAccountBookId()))
            && (this.getTime() == null ? other.getTime() == null : this.getTime().equals(other.getTime()))
            && (this.getTimeYear() == null ? other.getTimeYear() == null : this.getTimeYear().equals(other.getTimeYear()))
            && (this.getTimeMonth() == null ? other.getTimeMonth() == null : this.getTimeMonth().equals(other.getTimeMonth()))
            && (this.getTimeDay() == null ? other.getTimeDay() == null : this.getTimeDay().equals(other.getTimeDay()))
